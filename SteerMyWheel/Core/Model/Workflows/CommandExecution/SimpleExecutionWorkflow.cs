...
{
    public class SimpleExecutionWorkflow : BaseWorkflow
    {
        private ILogger<SimpleExecutionWorkflow> _logger { get; set; }
        ...
        public SimpleExecutionWorkflow(string name, string description,DateTime executionDate, ScriptExecution scriptExecution) : base(name, description,executionDate, null, null)
        {
